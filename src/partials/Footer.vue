          ...
          <ul class="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li class="ml-4">
              ...
              target="_blank"
                ...
                class="flex justify-center items-center text-green-600 bg-gray-800 hover:text-white hover:bg-green-500 rounded-full transition duration-150 ease-in-out"
