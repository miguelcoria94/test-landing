  ...
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-8">
        ...
        <!-- CTA box -->
        <div class="relative py-12 px-8 md:py-20 md:px-12">
