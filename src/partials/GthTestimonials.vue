    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pb-8">
        ...
        <div class="relative">
          ...
          <!-- Gray box -->
          <div class="absolute inset-0 bg-green-500 rotate-2 -z-10" aria-hidden="true"></div>
          ...
          <div class="relative px-6 pb-8 md:px-12 lg:pb-0">
            ...
            <div class="testimonial-carousel swiper-container">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                  <div class="shrink-0 relative inline-flex">
                    <img class="rounded-full" src="../images/kat.jpeg" width="240" height="200" alt="Testimonial 03" />
                  ...
                  <div class="relative">
                    ...
                    <h4 class="h3 font-cabinet-grotesk mb-4 text-gray-900">I highly recommend the products and services provided by this organization. I never feel alone in my journey while working with TadHealth. You can undoubtedly collaborate on relatable counselor resources and topics.</h4>
