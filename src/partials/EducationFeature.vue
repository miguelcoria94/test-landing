<template>
  <section class="relative">
    <!-- Dark background -->
    <div
      class="absolute inset-0 bg-green-500 pointer-events-none -z-10 [clip-path:polygon(0_0,_5760px_0,_5760px_calc(100%_-_352px),_0_100%)] h-96 md: md:mb-64"
      aria-hidden="true"
    ></div>
    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-playfair-display text-slate-100">
            Simplifying support with easy to use tools
          </h2>
        </div>
        ...
        >
          ...
          <article data-aos="fade-up">
            <router-link class="relative block group mt-8 mb-4" to="#0">
              ...
              <div
                class="w-16 h-16 absolute bg-gradient-to-b from-mint-500 to-mint-700 rounded-full -top-8 left-8"
              >
                <svg
            ...
            <h3 class="h4 font-playfair-display mb-2">
              <router-link
                class="hover:underline hover:decoration-blue-100"
                to="#0"
                >Booking Made Easy</router-link
              >
            </h3>
            <p class="text-lg text-gray-400">
              Book appointments in 3 steps. Continue operating phone booking
              while improving the ability to handle counseling requests.
            </p>
          </article>
          ...
          <article data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="text-lg text-gray-400">
              Our custom crisis tool helps improve digital access points to
              crisis resources. Ensure there are no hurdles when students need
              to access school and outside crisis resources.
            </p>
          </article>
          ...
          <article data-aos="fade-up" data-aos-delay="200">
            ...
            <h3 class="h4 font-playfair-display mb-2">
              <router-link
                class="hover:underline hover:decoration-blue-100"
                to="#0"
                >Smart Resources</router-link
              >
            </h3>
            <p class="text-lg text-gray-400">
              Transform static resources into engaging programming and content.
              Leverage the power of proactively connecting with students about
              their mental health and creating resources that meet students
              where they are.
            </p>
          </article>
        </div>
