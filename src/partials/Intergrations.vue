<template>
    <section class="relative">
      ...
      <div class="hidden md:block absolute w-0.5 h-8 bottom-10 bg-slate-200 left-1/2 -translate-x-1/2" aria-hidden="true"></div>
  
      <div class="max-w-6xl mx-auto px-4 sm:px-6 pt-20 pb-12  md:pt-14 md:pb-10"> 
        <div class="py-12 md:py-20">
          ...
          <div class="relative flex flex-col items-center p-16">
            <!-- Blurred dots -->
            <svg class="absolute top-1/2 -translate-y-1/2" width="557" height="93" xmlns="http://www.w3.org/2000/svg">
              <defs>
              ...
              <g fill="none" fill-rule="evenodd">
                <g class="fill-mint-600" transform="translate(437 8)">
                ...
                <g class="fill-mint-600" transform="matrix(-1 0 0 1 120 8)">
            ...
            <div class="relative w-32 h-32 flex justify-center items-center">
              <!-- Halo effect -->
              <!-- <svg class="absolute inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none h-auto max-w-[200%]" width="800" height="800" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
        ...
        />
          ...
          <!-- Integration boxes -->
          <div class="relative max-w-xs sm:max-w-md mx-auto md:max-w-6xl grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 mt-10 md:mt-20">
            <!-- Top vertical line -->
            <div class="hidden md:block absolute w-0.5 h-8 -top-16 -mt-2 bg-slate-200 left-1/2 -translate-x-1/2" aria-hidden="true"></div>
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
                <div class="absolute w-1/2 h-0.5 bg-slate-200 right-0"></div>
              </div>
              <!-- Circle -->
              <div class="bg-white w-20 h-20 rounded-full flex justify-center items-center">
                <!-- Icon -->
                <img src="../images/integration-icon-01.svg" width="36" height="46" alt="Icon 01">
              </div>
            </div>
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up" data-aos-delay="100">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
            ...
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up" data-aos-delay="200">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
                <div class="absolute w-full h-0.5 bg-slate-200"></div>
              ...
              <div class="bg-white w-20 h-20 rounded-full flex justify-center items-center">
                <!-- Icon -->
                <img src="../images/integration-icon-03.svg" width="43" height="35" alt="Icon 03" style="position: relative; right: -3px">
              </div>
            </div>
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up" data-aos-delay="300">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
                <div class="absolute w-full h-0.5 bg-slate-200"></div>
              ...
              <div class="bg-white w-20 h-20 rounded-full flex justify-center items-center">
                <!-- Icon -->
                <img src="../images/integration-icon-04.svg" width="48" height="46" alt="Icon 04" style="position: relative; right: 1px; top: 4px">
              </div>
            </div>
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up" data-aos-delay="400">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
                <div class="absolute w-full h-0.5 bg-slate-200"></div>
              ...
              <div class="bg-white w-20 h-20 rounded-full flex justify-center items-center">
                <!-- Icon -->
                <img src="../images/integration-icon-05.svg" width="49" height="48" alt="Icon 05" style="position: relative; right: 1px; top: 5px">
              </div>
            </div>
            <div class="relative flex justify-center items-center bg-slate-200 aspect-square p-2" data-aos="fade-up" data-aos-delay="500">
              <!-- Inner lines -->
              <div class="hidden md:block absolute inset-0 w-[calc(100%+24px)] h-6 -top-10 left-1/2 -translate-x-1/2" aria-hidden="true">
                <div class="absolute w-0.5 h-full bg-slate-200 left-1/2 -translate-x-1/2"></div>
              ...
              <div class="bg-white w-20 h-20 rounded-full flex justify-center items-center">
                <!-- Icon -->
                <img src="../images/integration-icon-06.svg" width="48" height="44" alt="Icon 06" style="position: relative; right: 1px; top: 4px">
              </div>
            </div>
