      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
          ...
          <div class="md:w-[640px]">
            <!-- Copy -->
            <h1 class="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">The platform for creative <span class="relative inline-flex text-mint-500">
            ...
            <p class="text-xl text-gray-500 mb-10" data-aos="fade-right" data-aos-delay="200">Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.</p>
            <!-- Buttons -->
          ...
          <div class="max-w-sm mx-auto md:max-w-none md:absolute md:left-[40rem] md:ml-16 lg:ml-32 xl:ml-52 mt-12 md:-mt-12" data-aos="fade-left" data-aos-duration="1100">
            <img src="../images/hero-image.png" class="md:max-w-none" width="584" height="659" alt="Hero Illustration" />
          </div>
