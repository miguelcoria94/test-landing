      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            >
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Jan 9, 2020</span>
                </div>
              </footer>
            </article>
            ...
            <article class="flex flex-col h-full" data-aos="fade-up">
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Jan 7, 2020</span>
                </div>
              </footer>
            </article>
            ...
            >
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Jan 4, 2020</span>
                </div>
              </footer>
            </article>
            ...
            >
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Jan 2, 2020</span>
                </div>
              </footer>
            </article>
            ...
            <article class="flex flex-col h-full" data-aos="fade-up">
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Dec 24, 2019</span>
                </div>
              </footer>
            </article>
            ...
            >
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Dec 12, 2019</span>
                </div>
              </footer>
            </article>
            ...
            >
              ...
              <footer class="flex items-center mt-4">
                ...
                <div class="font-medium">
                  ...
                  >
                  <span class="text-gray-700"> - </span>
                  <span class="text-gray-400">Dec 7, 2019</span>
                </div>
              </footer>
            </article>
          </div>
        ...
        >
          <ul class="inline-flex flex-wrap font-medium text-sm -m-1">
            <li class="m-1">
              <span
                class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-400"
                >Prev</span
              >
            </li>
            <li class="m-1">
              <a
                href="#0"
                class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-green-600 transition-colors duration-150 ease-in-out"
                >1</a
              >
            </li>
            <li class="m-1">
            ...
            <li class="m-1">
              <span
                class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-400"
                >...</span
              >
            </li>
            <li class="m-1">
            ...
            <li class="m-1">
              <a
                href="#0"
                class="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-300 hover:bg-green-600 transition-colors duration-150 ease-in-out"
                >Next</a
              >
            </li>
          </ul>
