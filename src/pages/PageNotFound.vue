        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          <div class="pt-32 pb-12 md:pt-40 md:pb-20">
            <div class="max-w-3xl mx-auto text-center">
              <!-- Top image -->
              <div
                class="relative inline-flex flex-col mb-6"
                data-aos="fade-up"
              >
                <img
                  class="rounded-full"
                ...
                />
                <svg
                  class="w-20 h-20 fill-current text-green-600 absolute top-0 right-0 -mr-6"
                  width="84"
                  height="80"
              ...
              <!-- 404 content -->
              <h1 class="h1 mb-4" data-aos="fade-up" data-aos-delay="200">
