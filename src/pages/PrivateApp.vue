          ...
          <div class="w-full max-w-md mx-auto">
            ...
            <form @submit.prevent="submit()">
              <div v-if="step === 'page1'">
                <div class="space-y-4">
                  <div>
                    <label class="block text-sm font-medium mb-1" for="practice"
                      >Practice Name <span class="text-rose-500">*</span></label
                    >
                    <input
                      id="practice"
                  ...
                  <div>
                    <label
                      ...
                      for="practicetype"
                      >Practice Type <span class="text-rose-500">*</span></label
                    >
                    <select
                      id="practicetype"
              ...
              <div v-if="step === 'page3a'">
                <div>
                  <label class="block text-sm font-medium mb-1" for="boardnumber"
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4 mt-5">
                  ...
                  <div class="sm:w-1/2">
                    <label class="block text-sm font-medium mb-1" for="boardexpyear"
              ...
              <div v-if="step === 'page3b'">
                <div>
                  <label class="block text-sm font-medium mb-1" for="licensenumber"
                    >License Number <span class="text-rose-500">*</span></label
                  >
                  <input
                    id="licensenumber"
                    class="form-input py-2 w-full"
