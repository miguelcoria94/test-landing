      ...
      <div class="min-h-screen h-full flex flex-col justify-center">
        <div class="px-5 sm:px-6">
          <div class="w-full max-w-md mx-auto">
            ...
            <span class="text-sm text-gray-400" v-if="step === 2"
              >Success!</span
            >
            ...
            <p class="text-xs text-gray-400 mb-4" v-if="step === 1">
              Please complete the form below so we can contact you with more
              information about how TadHealth can help grow your reach as a
              creator.
            </p>
            ...
            <p class="text-xs text-gray-400 mb-4" v-if="step === 2">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    <label
                      class="block text-sm font-medium mb-1"
                      for="audiencesize"
                      >Audience Size <span class="text-rose-500">*</span></label
                    >
                    <select
                      id="audiencesize"
                  ...
                  <div>
                    <label
                      ...
                      for="platforms"
                      >Platforms (select all that apply)<span
                        class="text-rose-500"
                        >*</span
                      ></label
                    >
...
export default {
  ...
  methods: {
    ...
    async submit() {
      try {
        if(!this.socialhandle || !this.audiencesize || !this.checkedplatforms || !this.phonenumber ) {
          this.$toast.warning(`Please fill out the entire form.`, {
            position: "top-right",
          });
          return;
          // function to the backend goes here
        }
      } catch(e) {
